...
import 'package:final_project/Admin/AdminHome.dart';
  ...
  handleAuth(){
    return StreamBuilder(
        ...
        builder: (BuildContext context, snapshot) {
          return snapshot.hasData?
          snapshot.data.phoneNumber == '+917397021749'||snapshot.data.phoneNumber == '+919442644704'?AdminHome(currentUser: snapshot.data,):
          Homepage(currentUser:snapshot.data):
          LoginPage();
        }
    );
...
//         //stream: FirebaseAuth.instance.onAuthStateChanged,
//         builder: (BuildContext context, snapshot) {
//           //var phoneNumber =   FirebaseAuth.instance.onAuthStateChanged;
//           return snapshot.hasData?
//           snapshot.data.phoneNumber == '+917397021749'||snapshot.data.phoneNumber == '+919442644704'?AdminHome(currentUser: snapshot.data,):
//           Homepage(currentUser:snapshot.data):
//           LoginPage();
...
//   }
  ...
  signIn({AuthCredential authCreds, String name, String phone}) async{
    ...
    FirebaseUser user = await FirebaseAuth.instance.currentUser;   //here
    //UserUpdateInfo updateInfo = UserUpdateInfo();
    //updateInfo.displayName=name;
    user.updateProfile(displayName: user.displayName);     //here
